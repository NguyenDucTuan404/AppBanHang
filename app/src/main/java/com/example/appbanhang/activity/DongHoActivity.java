    ...
    private void loadMore() {
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                adapterDh.notifyItemInserted(sanPhamMoiList.size()-1);
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                adapterDh.notifyItemRemoved(sanPhamMoiList.size());
                page = page+1;
                getData(page);
                        ...
                        sanPhamMoiModel -> {
                            if (sanPhamMoiModel.isSuccess()){
                                if (adapterDh == null){
                                    ...
                                    adapterDh = new DienThoaiAdapter(getApplicationContext(), sanPhamMoiList);

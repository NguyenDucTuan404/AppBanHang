    ...
    private void loadMore() {
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                adapterPk.notifyItemInserted(sanPhamMoiList.size()-1);
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                adapterPk.notifyItemRemoved(sanPhamMoiList.size());
                page = page+1;
                getData(page);
                adapterPk.notifyDataSetChanged();
                isLoading = false;
            }
        },2000);
    }
                        ...
                        sanPhamMoiModel -> {
                            if (sanPhamMoiModel.isSuccess()){
                                if (adapterPk == null){
                                    ...
                                    adapterPk = new DienThoaiAdapter(getApplicationContext(), sanPhamMoiList);
                                    recyclerView.setAdapter(adapterPk);
                                }else {
                                    ...
                                    adapterPk.notifyItemRangeInserted(vitri, soluongadd);
                                }

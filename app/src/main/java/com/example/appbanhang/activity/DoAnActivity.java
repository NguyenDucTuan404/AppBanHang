...
public class DoAnActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loai = getIntent().getIntExtra("loai",13);
    ...
    private void loadMore() {
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                adapterDa.notifyItemInserted(sanPhamMoiList.size()-1);
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                adapterDa.notifyItemRemoved(sanPhamMoiList.size());
                page = page+1;
                getData(page);
                adapterDa.notifyDataSetChanged();
                isLoading = false;
            }
        },2000);
    }
                        ...
                        sanPhamMoiModel -> {
                            if (sanPhamMoiModel.isSuccess()){
                                if (adapterDa == null){
                                    ...
                                    adapterDa = new DienThoaiAdapter(getApplicationContext(), sanPhamMoiList);
                                    recyclerView.setAdapter(adapterDa);
                                }else {
                                    ...
                                    adapterDa.notifyItemRangeInserted(vitri, soluongadd);
                                }

...
public class MyPhamActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loai = getIntent().getIntExtra("loai",8);
    ...
    private void loadMore() {
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                adapterMp.notifyItemInserted(sanPhamMoiList.size()-1);
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                adapterMp.notifyItemRemoved(sanPhamMoiList.size());
                page = page+1;
                getData(page);
                        ...
                        sanPhamMoiModel -> {
                            if (sanPhamMoiModel.isSuccess()){
                                if (adapterMp == null){
                                    ...
                                    adapterMp = new DienThoaiAdapter(getApplicationContext(), sanPhamMoiList);
                                    recyclerView.setAdapter(adapterMp);
                                }else {
                                    ...
                                    adapterMp.notifyItemRangeInserted(vitri, soluongadd);
                                }

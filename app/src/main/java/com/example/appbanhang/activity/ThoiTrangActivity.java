    ...
    private void loadMore() {
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                adapterTt.notifyItemInserted(sanPhamMoiList.size()-1);
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                adapterTt.notifyItemRemoved(sanPhamMoiList.size());
                page = page+1;
                getData(page);
                        ...
                        sanPhamMoiModel -> {
                            if (sanPhamMoiModel.isSuccess()){
                                if (adapterTt == null){
                                    ...
                                    adapterTt = new DienThoaiAdapter(getApplicationContext(), sanPhamMoiList);
                                    recyclerView.setAdapter(adapterTt);
                                }else {
                                    ...
                                    adapterTt.notifyItemRangeInserted(vitri, soluongadd);
                                }

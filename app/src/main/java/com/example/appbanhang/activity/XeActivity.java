...
public class XeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loai = getIntent().getIntExtra("loai", 9);
    ...
    private void loadMore() {
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                adapterXe.notifyItemInserted(sanPhamMoiList.size() - 1);
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                adapterXe.notifyItemRemoved(sanPhamMoiList.size());
                page = page + 1;
                getData(page);
                        ...
                        sanPhamMoiModel -> {
                            if (sanPhamMoiModel.isSuccess()) {
                                if (adapterXe == null) {
                                    ...
                                    adapterXe = new DienThoaiAdapter(getApplicationContext(), sanPhamMoiList);
                                    ...
                                    adapterXe.notifyItemRangeInserted(vitri, soluongadd);
                                }
